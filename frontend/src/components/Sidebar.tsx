...
import { I } from "./Icons";
import { SetVideoRetentionLimit, GetVideoRetentionLimit } from "../../bindings/tavlio/dbase/store";
...
export function Sidebar({ open, onOpen, onClose }: SidebarProps) {
  ...
  // Strips non-numeric characters on the fly
  ...
  // Buttons use this to do the math safely
                      ...
                      >
                        ...
                        <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
                           <input
                             ...
                             inputMode="numeric" // <-- TELLS MOBILE DEVICES TO USE NUMBER PAD
                             value={inputValue}
                             onChange={handleRetentionChange}
                             onBlur={handleRetentionBlur} // <-- SAVES ON BLUR
                             style={{
                               width: "42px",
                               background: "transparent",
